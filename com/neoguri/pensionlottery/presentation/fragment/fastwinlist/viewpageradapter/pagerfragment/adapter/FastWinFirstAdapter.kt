...
class FastWinFirstAdapter constructor(context: Context, itemLayout: Int) :
    RecyclerView.Adapter<FastWinFirstAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, position: Int) {
        ...
        val split = lottoItemList.pensionlotteryNum.split(",".toRegex()).dropLastWhile { it.isEmpty() }.toTypedArray()
        ...
        initSetText(viewHolder.lottoText7, lottoItemList.pensionlotteryTitleNum)
        ...
        initSetColor(viewHolder.lotto7, viewHolder.lotto7Taedoori, ContextCompat.getColor(mContext, R.color.color_teadoori_))
